...
train_time = t_{high} - (t_{high} -t_{low})*{1-.997^{m+f^{1.3}}}
-->
<img src="https://latex.codecogs.com/gif.latex?train_time%20=%20t_{high}%20-%20(t_{high}%20-t_{low})*{1-.997^{m+f^{1.3}}}"/>
